...
namespace ZWaveLib2
{
    ...
    public class NodeCapabilities
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeCapabilities"/> class.
        /// </summary>
    ...
    public class NodeCommandClass
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeCommandClass"/> class.
        /// </summary>
    ...
    public class ZWaveNode
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZWaveNode"/> class.
        /// </summary>
        public ZWaveNode()
        {
        ...
        internal virtual bool ApplicationCommandHandler(byte[] rawMessage)
        {
            ...
            if (messageLength > 8)
            {
                ...
                try
                {
                    ...
                    {
                        Logger.LogDebug("CommandClass {0} not supported yet", commandClass);
                    }
                }
                catch (Exception ex)
                {
            ...
            {
                Logger.LogWarning("Unhandled message type: {0}", BitConverter.ToString(rawMessage));
            }
