...
namespace ZWaveLib2
{
    ...
    {
        private static readonly ILogger<ZWaveMessage> Logger = LogFactory.GetLogger<ZWaveMessage>();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZWaveMessage"/> class.
        /// </summary>
        ...
        public ZWaveMessage(byte[] message, MessageDirection direction = MessageDirection.Outbound, bool generateCallback = false)
        {
            ...
            Logger.LogDebug("ZWaveMessage (RawData={0})", BitConverter.ToString(RawData));
            if (Direction == MessageDirection.Inbound)
                Logger.LogDebug("ZWaveMessage (Direction={0}, Header={1}, NodeId={2}, Type={3}, Function={4}, CommandClass={5})",
                    Direction, Header, NodeId, Type, Function, CommandClass);
            else
                Logger.LogDebug("ZWaveMessage (Direction={0}, Header={1}, NodeId={2}, Type={3}, Function={4}, CommandClass={5}, CallbackId={6}, CallbackStatus={7})",
